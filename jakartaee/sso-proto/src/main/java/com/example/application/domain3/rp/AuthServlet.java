...
@WebServlet("/domain3/rp/auth")
public class AuthServlet extends HttpServlet {
    private static final Logger logger = Logger.getLogger(AuthServlet.class.getName());
    private static final String LOG_PREFIX = ">>> [RP3]: " + AuthServlet.class.getSimpleName() + ": ";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (code == null || code.isBlank()) {
            ...
            resp.sendRedirect(req.getContextPath() + "/domain3/rp/error");
            return;
        }
        ...
        resp.sendRedirect(req.getContextPath() + "/domain3/rp/top");
        return;
    }
